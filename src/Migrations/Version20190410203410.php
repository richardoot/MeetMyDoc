 ...
 */
final class Version20190410203410 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE ressource_dossier_patient (id INT AUTO_INCREMENT NOT NULL, type_ressource_dossier_patient_id INT NOT NULL, dossier_patient_id INT NOT NULL, INDEX IDX_3C9A2ECF98D86708 (type_ressource_dossier_patient_id), INDEX IDX_3C9A2ECF45F3D65C (dossier_patient_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
